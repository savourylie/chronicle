...
## Requirements
- [ ] Initialize Next.js 16 project with App Router (`npx create-next-app@latest`)
- [ ] Configure TypeScript with strict mode in `tsconfig.json`
- [ ] Install and configure Tailwind CSS v4
- [ ] Install shadcn/ui and run `npx shadcn@latest init`
...
- [ ] Add `.gitignore` entries for `node_modules`, `.next`, `.env.local`
...
- [ ] shadcn/ui is initialized and ready for component additions
