...
## Acceptance Criteria
- [x] All 5 URL formats are correctly parsed
- [x] Invalid URLs return descriptive error messages
- [x] Branch names with slashes (e.g., `feature/foo`) are handled
- [x] Unit tests pass with >95% branch coverage
- [x] No external dependencies required (pure string parsing)
