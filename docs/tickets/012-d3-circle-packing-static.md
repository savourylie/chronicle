...
## Requirements
- [x] Create a React component that renders a D3 circle-packing layout:
...
- [x] Render 3 levels of the hierarchy:
...
- [x] Responsive: fill the visualization area from the layout shell
...
## Acceptance Criteria
- [x] Mock data renders as nested circles on screen
- [x] All 3 levels of hierarchy are visible
- [x] Circles are correctly sized based on the selected size encoding
- [x] Group labels are readable where space allows
- [x] Clicking a circle updates `selectedNode` in the store
- [x] 150-node mock data renders in under 200ms
- [x] Labels do not overlap at the initial zoom level
- [x] Component fills its container responsively
- [x] No console errors or D3 warnings
