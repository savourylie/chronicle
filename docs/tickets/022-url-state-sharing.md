...
## Requirements
- [x] Encode state in URL search params:
...
- [x] Handle invalid/stale URLs gracefully:
...
## Acceptance Criteria
- [x] Zooming in/out updates the URL without page reload
- [x] Copying the URL and opening in a new tab restores the same view
- [x] Changing encoding updates the URL
- [x] Invalid URL params are handled gracefully (no crashes)
- [x] Browser back/forward buttons work with zoom history
